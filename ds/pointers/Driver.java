...
public class Driver{
	...
	// Add a line to set the walker variable defined above so that it points to (refers to) the same node as the variable front points to.
	...
	// Add the code necessary to set up a loop that
